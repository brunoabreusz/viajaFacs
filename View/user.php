...
<body>
    ...
    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/img-salvador.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="images/img-saopaulo.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="images/img-belohorizonte.png" class="d-block w-100" alt="...">
            </div>
        </div>
    ...
    <div class="container-fluid" id="GreyBackground">
            ...
            <div class="row">
                <form name="cadastro" onsubmit="return checkPasswords()">
                    <div class="input-group">
                        ...
                        <input class="form-control" name="origem" id="origem" placeholder="Origem" required>
    
                        <input class="form-control" name="destino" id="destino" placeholder="Destino" required>
                        <span class="input-group-text"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                    ...
                    <div class="form-check form-check-inline mt-3">
                        <input class="form-check-input" type="radio" name="passagem" id="inlineRadio1"
                            value="idaVolta">
                    ...
                    <div class="form-check form-check-inline mt-3">
                        <input class="form-check-input" type="radio" name="passagem" id="inlineRadio3" value="option3"
                            disabled>
            ...
            <div class="row row-cols-md-4 g-4 justify-content-around">
                ...
                <div class="card p-0 cardT" style="width: 20rem">
                    <a id="Passagem" href="tickets.html">
                        <img src="https://media.staticontent.com/media/pictures/d184a06f-db25-4ec6-bc21-b73bc4db0ca9"
                ...
                <div class="card p-0 cardT" style="width: 20rem">
                    <a id="Passagem" href="tickets.html">
                        <img src="https://media.staticontent.com/media/pictures/408861fa-25f7-4b7b-a395-a5311e7c51f2"
                            class="card-img-top" style="height: 200px;" alt="...">
                        <div class="card-body">
                            <h6 class="card-text fw-normal">Passagem</h6>
                ...
                <div class="card p-0 cardT" style="width: 20rem">
                    <a id="Passagem" href="tickets.html">
                        <img src="https://media.staticontent.com/media/pictures/80081fcb-d440-45eb-a770-318317a7ae04"
                            class="card-img-top" style="height: 200px;" alt="...">
                        <div class="card-body">
                            <h6 class="card-text fw-normal">Passagem</h6>
                ...
                <div class="card p-0 cardT" style="width: 20rem">
                    <a id="Passagem" href="tickets.html">
                        <img src="https://images.pexels.com/photos/6057833/pexels-photo-6057833.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                            class="card-img-top" style="height: 200px;" alt="...">
                        <div class="card-body">
                            <h6 class="card-text fw-normal">Passagem</h6>
                ...
                <div class="card p-0 cardT" style="width: 20rem">
                    <a id="Passagem" href="tickets.html">
                        <img src="https://images.pexels.com/photos/14236881/pexels-photo-14236881.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                            class="card-img-top" style="height: 200px;" alt="...">
                        <div class="card-body">
                            <h6 class="card-text fw-normal">Passagem</h6>
                            <h5 class="card-title fw-semibold">Voos para Salvador</h5>
                ...
                <div class="card p-0 cardT" style="width: 20rem">
                    <a id="Passagem" href="tickets.html">
                        <img src="https://images.pexels.com/photos/1268855/pexels-photo-1268855.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                            class="card-img-top" style="height: 200px;" alt="...">
                        <div class="card-body">
                            <h6 class="card-text fw-normal">Passagem</h6>
                            <h5 class="card-title fw-semibold">Voos para Rio de Janeiro</h5>
                ...
                <div class="card p-0 cardT" style="width: 20rem">
                    <a id="Passagem" href="tickets.html">
                        <img src="https://images.pexels.com/photos/13435510/pexels-photo-13435510.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                            class="card-img-top" style="height: 200px;" alt="...">
                        <div class="card-body">
                            <h6 class="card-text fw-normal">Passagem</h6>
                            <h5 class="card-title fw-semibold">Voos para Belo Horizonte</h5>
                ...
                <div class="card p-0 cardT" style="width: 20rem">
                    <a id="Passagem" href="tickets.html">
                        <img src="https://images.pexels.com/photos/1482193/pexels-photo-1482193.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                            class="card-img-top" style="height: 200px;" alt="...">
                        <div class="card-body">
                            <h6 class="card-text fw-normal">Passagem</h6>
                            <h5 class="card-title fw-semibold">Voos para São Paulo</h5>
        ...
        <div class="container mt-5" id="Ajuda">
            <div class="row row-cols-md-4 g-4 justify-content-around">
                <figure class="figure">
                    <img src="https://media.staticontent.com/media/pictures/bf76ebe3-7301-40c6-ad17-4e3e10879159"
                        width="300px" class="figure-img img-fluid rounded mx-auto d-block"
                ...
                <figure class="figure">
                    <img src="https://media.staticontent.com/media/pictures/b0e700eb-ba6a-4baf-9e58-15687cb95a28"
                        width="300px" class="figure-img img-fluid rounded mx-auto d-block"
                        alt="A generic square placeholder image with rounded corners in a figure.">
                ...
                <figure class="figure">
                    <img src="https://media.staticontent.com/media/pictures/2a2f0df8-3c25-407d-8074-f76ac4961bdb"
                        width="300px" class="figure-img img-fluid rounded mx-auto d-block"
                        alt="A generic square placeholder image with rounded corners in a figure.">
                ...
                <figure class="figure">
                    <img src="https://media.staticontent.com/media/pictures/9887b3c0-5988-4a0a-83f4-e80ee1d2aeea"
                        width="300px" class="figure-img img-fluid rounded mx-auto d-block"
                        alt="A generic square placeholder image with rounded corners in a figure.">
    ...
    <footer class="bg-light">
        ...
        <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.05);">
            © 2023 Copyright:
            <a class="fw-bold" id="AmareloTexto" target="_blank"
                href="https://github.com/brunoabreusz">viajafacs.com.br</a>
        </div>
