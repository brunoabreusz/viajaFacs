...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active">Cancelamaneto</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container-fluid bg-danger p-4">
        <h1 class="text-center fw-bold" id="White">Cancelamaneto</h1>
    </div>
    ...
    <div class="container col-11 col-md-9" id=".">
        <div class="row align-items-center gx-5">
            <div class="col-md-6 order-md-2">
                <img src="../View/images/Cancel.png" alt="Warning" class="img-fluid mx-auto d-block">
            </div>
